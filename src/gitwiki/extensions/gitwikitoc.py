...
Changes made for gitwiki in order to get toc through the extension
...
from markdown.util import etree, parseBoolValue, AMP_SUBSTITUTE, HTML_PLACEHOLDER_RE, string_type
import re
import unicodedata
